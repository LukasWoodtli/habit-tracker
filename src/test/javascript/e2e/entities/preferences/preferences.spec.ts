...
describe('Preferences e2e test', () => {
  ...
  it('should load Preferences', async () => {
    ...
    expect(await preferencesComponentsPage.getTitle()).to.eq('habitTrackerApp.preferences.home.title');
    await browser.wait(
  ...
  it('should load create Preferences page', async () => {
    ...
    expect(await preferencesUpdatePage.getPageTitle()).to.eq('habitTrackerApp.preferences.home.createOrEditLabel');
  ...
  /* it('should delete last Preferences', async () => {
        ...
        expect(await preferencesDeleteDialog.getDialogTitle())
            .to.eq('habitTrackerApp.preferences.delete.question');
