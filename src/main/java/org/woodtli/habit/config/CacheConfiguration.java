package org.woodtli.habit.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.woodtli.habit.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.woodtli.habit.repository.UserRepository.USERS_BY_EMAIL_CACHE);
